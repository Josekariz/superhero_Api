...
hp1=HeroPower.create!({strength: "Avarage",power_id: p1.id, hero_id: h1.id})
...
h2=Hero.create!({name: "Saitama", super_name: "One Punch man" })

hp2=HeroPower.create!({strength: "Strong",power_id: p2.id, hero_id: h2.id})
puts '######### 2 done'


h3=Hero.create!({name: "Jonathan Kent", super_name: "Superboy" })
...
hp3=HeroPower.create!({strength: "Average",power_id: p3.id, hero_id: h3.id})
hp4=HeroPower.create!({strength: "Average",power_id: p4.id, hero_id: h3.id})
puts '######### 3 done'
...
h5=Hero.create!({name: "Brec Bassinger ", super_name: "Stargirl" })
hp5=HeroPower.create!({strength: "Weak",power_id: p5.id, hero_id: h5.id})
puts '######### all  done'
